...
export default function PageGallery() {
  ...
  // 24 archetypes is more than fits on a screen; filtering beats scrolling.
  ...
  return (
    <div className="page">
      ...
      <header className="wrap page-header">
        ...
        <p className="lede">
          24 archetypes plus the three originals, all on the same design system. Click any card —
