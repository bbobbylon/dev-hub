...
_Last updated: 2026-09-20 — describes the 41-page app plus the optional `server/` backend, on the
`polish-content-gaps` branch._
...
see that root `README.md`). It ships ~40 standalone interactive lesson/tool pages behind one
