...
_Last updated: 2026-09-18 — describes the 33-page app plus the optional `server/` backend, on the
...
see that root `README.md`). It ships ~33 standalone interactive lesson/tool pages behind one
