...
_Last updated: 2026-09-13 — describes the 26-page app plus the optional `server/` backend, on the
...
see that root `README.md`). It ships ~29 standalone interactive lesson/tool pages behind one
