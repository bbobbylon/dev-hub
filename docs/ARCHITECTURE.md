...
_Last updated: 2026-09-18 — describes the 34-page app plus the optional `server/` backend, on the
...
see that root `README.md`). It ships ~34 standalone interactive lesson/tool pages behind one
