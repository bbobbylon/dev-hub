...
_Last updated: 2026-09-18 — describes the 30-page app plus the optional `server/` backend, on the
...
see that root `README.md`). It ships ~30 standalone interactive lesson/tool pages behind one
