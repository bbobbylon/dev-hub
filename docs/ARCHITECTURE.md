...
_Last updated: 2026-09-19 — describes the 39-page app plus the optional `server/` backend, on the
...
see that root `README.md`). It ships ~39 standalone interactive lesson/tool pages behind one
