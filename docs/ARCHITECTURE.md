...
_Last updated: 2026-09-19 — describes the 35-page app plus the optional `server/` backend, on the
...
see that root `README.md`). It ships ~35 standalone interactive lesson/tool pages behind one
